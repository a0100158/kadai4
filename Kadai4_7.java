...
public class  Kadai4_7{
	public static void main(String[] args) throws IOException{
		...
		Kadai4_7_DAO Kadai4_7_DAO = new Kadai4_7_DAO();
	...
	public static void choice(String srtOneInput) throws IOException {
		...
		case "select" :
			...
			if(srtBookTitle == null || srtBookTitle.length() == 0){
				...
				List valueList = Kadai4_7_DAO.find(srtBookTitle);
		...
		case "insert" :
			...
			Kadai4_7_DAO.setBook(srtB_Genre,srtB_Title,intB_Price,strB_Author,strB_Publisher,srtB_Date);
			System.out.println();
			System.out.println();
			...
			Kadai4_7_DAO.setLibrary(strL_Library_name);
			System.out.println();
			System.out.println();
			...
			Kadai4_7_DAO.setPegging(intP_Library_id,intP_Id);

			Kadai4_7_DAO.dbConnect();
			break;
		case "update" :
	...
	private static void choiceUpdateTable(String updateTargetTable)  throws IOException {
		...
		case "本":
			...
			List<Book> UpdateBookTableDataList = Kadai4_7_DAO.getUpdateTableData(updateTargetTable);
			...
			Kadai4_7_DAO.sendUpdateBookValue(intUpdateBookPrice,srtB_Date,intUpdateTargetBookId);
		...
		case "図書館":
			...
			List<Library> UpdateLibraryTableDataList = Kadai4_7_DAO.getUpdateTableData(updateTargetTable);
			...
			Kadai4_7_DAO.sendUpdateLibraryValue(strUpdateLibrary_name,intUpdateTargetLibrary_id);
		...
		case "ひも付き":
			...
			List<Pegging> UpdatePeggingTableDataList = Kadai4_7_DAO.getUpdateTableData(updateTargetTable);
			...
			Kadai4_7_DAO.sendUpdatePeggingValue(intUpdateLibrary_id,intUpdateTargetPegging_id);
			System.out.println();
			System.out.println("更新しました。");
			break;
